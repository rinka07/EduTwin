...
(function () {
  ...
  var TRAD = {
    fr: {
      ...
      "student.timer.done": "Terminé",
      "student.timer.overToast": "Temps dépassé sur « {tache} ». La tâche suivante démarre ; l'enseignant est prévenu.",
      "student.auto.hint": "Démarre automatiquement (minuteur séquentiel).",
      "student.current.hint": "Tâche en cours : le décompte tourne. Terminez-la pour lancer la suivante.",
    ...
    en: {
      ...
      "student.timer.done": "Done",
      "student.timer.overToast": "Time exceeded on “{tache}”. The next task starts; your teacher has been notified.",
      "student.auto.hint": "Starts automatically (sequential timer).",
      "student.current.hint": "Current task: the countdown is running. Finish it to start the next one.",
